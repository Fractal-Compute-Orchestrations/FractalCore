...
def serialize(delegated_graph: DelegateOutput, layer_idx: int, output_dir: str) -> str:
    ...
    print(f"[Workstation 5] Exporting layer {layer_idx} to PTE format at '{output_path}'...")
    ...
    print(f"[Workstation 5] Layer {layer_idx} exported successfully. Size: {file_size} bytes.")
